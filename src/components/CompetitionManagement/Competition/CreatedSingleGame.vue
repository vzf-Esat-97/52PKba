<template>
  <div v-if="competitionE" id="base-info">
    ...
    <div class="gameMode">
      <font>游戏模式：<span>{{competitionE.gameMode.value}}</span> <span>{{competitionE.gameMode.value1}}</span> <span>{{competitionE.gameMode.value2}}</span></font>
    </div>
    ...
    <div @click="isShowstageselect=!isShowstageselect" class="CompetitionStage">
      <font>赛事阶段</font>
    ...
    <div @click="isShowrewardselect=!isShowrewardselect" class="CompetitionStage kindstyle">
      <font>奖励描述</font>
      <transition name="fade">
    ...
    <div @click="ruleDescription=!ruleDescription" class="CompetitionStage kindstyle">
      <font>规则描述</font>
      <transition name="fade">
    ...
    <div @click="gameDescription=!gameDescription" class="CompetitionStage kindstyle">
      <font>赛事描述</font>
      <transition name="fade">
